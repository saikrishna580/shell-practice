...
then 
    ...
    echo -e "Nothimg to do Mysql....$Y already installed $N" &>>$LOG_FILE
 fi 
...
then 
    ...
    echo -e "Nothimg to do python....$Y already installed $N" &>>$LOG_FILE
 fi
...
then 
    ...
    echo -e "Nothimg to do nginx....$Y already installed $N" &>>$LOG_FILE
 fi